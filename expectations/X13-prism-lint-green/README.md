...
`pnpm -F prism lint` against the kaleidoscope HEAD snapshot exits green.
...
- [`evidence/X13.stdout.txt`](evidence/X13.stdout.txt) — full toolchain log.
- [`evidence/X13.stderr.txt`](evidence/X13.stderr.txt) — pnpm progress noise.
