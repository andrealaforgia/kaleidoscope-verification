# A05 — otlp-http-protobuf-logs-accepted
...
When an OTLP/http client sends an `ExportlogServiceRequest` containing N logs to the matching listener
...
- [`evidence/aperture.live.stderr.txt`](evidence/aperture.live.stderr.txt) — aperture's container stderr captured live during the run; the matched line is verbatim:
  `aperture-1  | {"timestamp":"2026-05-06T23:26:37.512266Z","level":"INFO","event":"sink_accepted","sink":"forwarding","downstream":"http://otelcol-sink:4318","signal":"logs","record_count":1,"downstream_latency_ms":1,"resource.service.name":"expectation-A05-pilot"}`
