...
`pnpm -F prism vitest` against the kaleidoscope HEAD snapshot exits green.
...
- [`evidence/X12.stdout.txt`](evidence/X12.stdout.txt) — full toolchain log.
- [`evidence/X12.stderr.txt`](evidence/X12.stderr.txt) — pnpm progress noise.
