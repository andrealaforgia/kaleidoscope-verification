# S17 — deadline-exceeded-warn-event
...
On an expired flush deadline, a tracing WARN follows: "flush deadline exceeded dropped=unknown flush_timeout_ms=N".
...
- Inter-session feed (other claude session, 2026-05-06): item **S17**.
...
```
harness/run-expectation.sh S17
```
