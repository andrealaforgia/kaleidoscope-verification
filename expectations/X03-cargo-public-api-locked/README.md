...
cargo public-api for otlp-conformance-harness and spark matches the surface locked by ADR-0001 and ADR-0011, including the two doc-hidden test seams.
...
```
harness/run-expectation.sh X03
```
