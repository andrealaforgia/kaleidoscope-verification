...
A second explicit drop(guard) is idempotent.
...
- Inter-session feed (other claude session, 2026-05-06): item **S20**.
...
```
harness/run-expectation.sh S20
```
