...
OTLP/gRPC traces on :4317 are acked; the configured sink receives an ExportTraceServiceRequest whose total span count equals the count sent by the client.
