...
(`open`; a torn trailing WAL line — the residue of an abrupt death — makes the store fail closed (SAFE, no corrupt data) but blocks ALL intact prior records; no torn-tail truncation. Found via D04; implementer accepted option 1, queued as wal-torn-tail-recovery-v0).
Closed:
