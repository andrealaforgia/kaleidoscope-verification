...
| `satisfied` | 150 (A 18 + S 12 + E 0 + X 14 + L 6 + K 33 + Q 10 + G 6 + EG 4 + LQ 10 + TQ 7 + D 20 + B 10) |
...
| [K18](K18-cli-tier-unknown-item-clean-message/README.md) | cli-tier-unknown-item-clean-message | Unknown item on `migrate`/`get-tier` fails closed (exit 1) but the diagnostic leaks `ItemId("ghost")` instead of `"ghost"` (UC-TIER-008/009, [issue 011](../issues/011-cli-unknown-item-diagnostic-leaks-itemid-debug.md)); transition-proof. | `broken` |
