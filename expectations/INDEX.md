...
| Status | Count |
|---|---|
| `pending` | 21 (15 in S/E/X + 6 SI blocked on N8 — all B satisfied; B06 flipped GREEN, SLO engine now operator-wired) |
| `satisfied` | 141 (A 18 + S 12 + E 4 + X 14 + L 6 + K 32 + Q 8 + G 3 + EG 2 + LQ 7 + TQ 5 + D 20 + B 10) |
