...
| Status | Count |
|---|---|
| `pending` | 26 (15 in S/E/X + 6 SI blocked on N8 + 5 B — B02 now satisfied, B01/B03-B06 reuse its harness) |
| `satisfied` | 105 (A 15 + S 12 + E 4 + X 14 + L 6 + K 13 + Q 5 + G 3 + EG 1 + LQ 7 + TQ 4 + D 20 + B 1) |
