...
| Status | Count |
|---|---|
| `pending` | 25 (15 in S/E/X + 6 SI blocked on N8 + 4 B — B01/B02 satisfied, B03-B06 reuse the harness) |
| `satisfied` | 106 (A 15 + S 12 + E 4 + X 14 + L 6 + K 13 + Q 5 + G 3 + EG 1 + LQ 7 + TQ 4 + D 20 + B 2) |
