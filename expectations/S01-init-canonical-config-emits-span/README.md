...
spark::init with a canonical config returns Ok(SparkGuard); a span emitted via opentelemetry::global::tracer(...) reaches Aperture.
...
```
harness/run-expectation.sh S01
```
