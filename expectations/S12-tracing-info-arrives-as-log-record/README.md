# S12 — tracing-info-arrives-as-log-record
...
tracing::info!(target: "<app-target>", ...) reaches Aperture as an ExportLogsServiceRequest.
...
- Inter-session feed (other claude session, 2026-05-06): item **S12**.
...
```
harness/run-expectation.sh S12
```
