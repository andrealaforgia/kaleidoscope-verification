...
On a configured interval (default 60s), Sieve emits one INFO-level structured tracing event summarising the kept and dropped counters since the previous summary. Counters are AtomicU64 internally; the summary reads them and is non-resetting cumulative since Sieve started.

## Source

- External contract anchor:
  [`docs/feature/sieve/slices/slice-06-observability.md`](https://github.com/andrealaforgia/kaleidoscope/blob/HEAD/docs/feature/sieve/slices/slice-06-observability.md)
  and
