...
OTLP/HTTP/protobuf metrics on :4318 — 200 OK; the sink receives an ExportMetricsServiceRequest with the original data points.
...
```
harness/run-expectation.sh A06
```
