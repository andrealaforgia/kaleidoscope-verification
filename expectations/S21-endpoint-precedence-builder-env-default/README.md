# S21 — endpoint-precedence-builder-env-default
...
OTLP endpoint precedence: SparkConfig::with_endpoint(...) > OTEL_EXPORTER_OTLP_ENDPOINT env var > default http://127.0.0.1:4317.
...
- Inter-session feed (other claude session, 2026-05-06): item **S21**.
...
```
harness/run-expectation.sh S21
```
