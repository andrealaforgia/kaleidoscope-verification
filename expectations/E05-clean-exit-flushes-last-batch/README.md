# E05 — clean-exit-flushes-last-batch
...
An app exiting cleanly drops SparkGuard; the last batch reaches Aperture before the process exits. No silent data loss.
...
- Inter-session feed (other claude session, 2026-05-06): item **E5**.
...
```
harness/run-expectation.sh E05
```
