...
OTLP/gRPC metrics on :4317 are acked; the sink receives an ExportMetricsServiceRequest carrying the data points sent by the client.
...
```
harness/run-expectation.sh A03
```
