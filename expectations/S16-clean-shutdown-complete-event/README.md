# S16 — clean-shutdown-complete-event
...
On clean flush, a tracing INFO follows: "shutdown complete drained=unknown". Per N5 the value is "unknown" at v0; the contract is the "drained=" prefix.
...
- Inter-session feed (other claude session, 2026-05-06): item **S16**.
...
```
harness/run-expectation.sh S16
```
