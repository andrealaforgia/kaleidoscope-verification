# SI03 — sieve-trace-id-determinism
...
Two spans carrying the same trace_id receive the same sampling decision, regardless of arrival order or wall clock. Implementation: xxh3_64(trace_id) mod rate-denominator.

## Source

- External contract anchor:
  [`docs/feature/sieve/slices/slice-04-trace-id-determinism.md`](https://github.com/andrealaforgia/kaleidoscope/blob/HEAD/docs/feature/sieve/slices/slice-04-trace-id-determinism.md)
  and
