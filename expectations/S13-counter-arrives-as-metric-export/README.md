# S13 — counter-arrives-as-metric-export
...
A counter incremented via opentelemetry::global::meter("...").u64_counter("...").build().add(1, &[]) reaches Aperture as an ExportMetricsServiceRequest after flush.
...
- Inter-session feed (other claude session, 2026-05-06): item **S13**.
...
```
harness/run-expectation.sh S13
```
