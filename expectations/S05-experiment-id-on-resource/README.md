...
With `with_experiment_id(id)`, the Resource carries an attribute `experiment.id` equal to the configured id. House attribute.

## Source

- Inter-session feed (other claude session, 2026-05-06): item **S5**.
- External contract anchor: [`docs/product/architecture/adr-0011-spark-public-api-and-crate-layout.md`](https://github.com/andrealaforgia/kaleidoscope/blob/HEAD/docs/product/architecture/adr-0011-spark-public-api-and-crate-layout.md) for the experiment.id house attribute.
...
- Method: driven by the **spark-consumer** fixture under
  ...
  Invoked with `--experiment-id exp-S05-123`.
