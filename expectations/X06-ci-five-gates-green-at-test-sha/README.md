# X06 — ci-five-gates-green-at-test-sha
...
CI on push to main shows the five gates green for the kaleidoscope SHA we test against. (Source feed cited a87ad9e — graduation of Spark — but the expectation is reformulated as "green at the SHA verified" to avoid going stale.)
...
- Inter-session feed (other claude session, 2026-05-06): item **X6**.
...
```
harness/run-expectation.sh X06
```
